...
def containers_show(id):
    ...
    curl -s -X GET -H 'Accept: application/json' http://localhost:8080/containers/8b5f4713c6a6 | python -mjson.tool
    """
...
def containers_log(id):
    ...
    curl -s -X GET -H 'Accept: application/json' http://localhost:8080/containers/8b5f4713c6a6/logs | python -mjson.tool
...
def images_remove(id):
    ...
    curl -s -X DELETE -H 'Accept: application/json' http://localhost:8080/images/e62e40e42a3b | python -mjson.tool
...
def containers_remove(id):
    ...
    curl -s -X DELETE -H 'Accept: application/json' http://localhost:8080/containers/8b5f4713c6a6 | python -mjson.tool
